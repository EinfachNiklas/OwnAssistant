...
server.registerTool(
    "set_shoppinglist_done_status",
    {
        ...
        inputSchema: {
            ...
            doneStatus: z.enum(["true", "false"]).describe("The new doneStatus value of the shoppinglist entry as a string ('true' or 'false')")
        }
    },
...
server.registerTool(
    "set_todolist_done_status",
    {
        ...
        inputSchema: {
            ...
            doneStatus: z.enum(["true", "false"]).describe("The new doneStatus value of the ToDo List entry as a string ('true' or 'false')")
        }
    },
    async ({ title, doneStatus }) => {
        try {
...
server.registerTool(
    "clear_done_todolist",
    {
        ...
        description: "Delete all Entries from the users ToDo List where isDone = true. If you want to give a summary of the remaining ToDos, call tool get_todolist_entries",
        inputSchema: {}
    },
    async () => {
        try {
